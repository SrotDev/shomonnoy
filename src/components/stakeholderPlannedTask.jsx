                                ...
                                <div className="flex flex-col mt-4 max-h-[calc(50vh)] scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-white scrollable-container overflow-y-scroll"> {/*Scrollable div*/}
                                    {
                                        tasks.map((item, idx) => {
                                            return (
                                                <motion.div
                                                    key={idx}
                                                    className="flex flex-col text-black my-2 mx-5 bg-white rounded-4xl w-[calc(70vw)] py-5 px-5 shadow-[4px_6px_20px_1px_rgba(0,0,0,0.25)] bg-white/90 backdrop-blur-md"
                                                ...
                                                >
                                                    ...
                                                    <div className="flex flex-row justify-between items-center">
                                                        ...
                                                        <div className="flex flex-row justify-center">
                                                            ...
                                                            <motion.div
                                                                className="w-8 h-8 rounded-lg bg-contain bg-center bg-no-repeat m-1"
                                                                style={{ backgroundImage: `url(${reloadLogo})` }}
                                                                initial={{ backgroundColor: "#FFFFFF" }}
                                                                whileHover={{ backgroundColor: "#C1E6FAFF", scale: 1.1 }}
                                                                onClick={() => null}
                                                            />
                                                            <motion.div
                                                                className="w-8 h-8 rounded-lg bg-contain bg-center bg-no-repeat m-1"
