...
var tasks = [
    { id: "WASA#18345", from: "1 Aug", to: "25 Aug", isEmergency: false, geometry: { "type": "LineString", "coordinates": [[90.370, 23.740], [90.375, 23.745]] } },
    { id: "BTCL#28112", from: "10 Aug", to: "29 Aug", isEmergency: false, geometry: { "type": "LineString", "coordinates": [[90.380, 23.750], [90.385, 23.755]] } },
];

export default function StakeholderDoneTask() {
    ...
    useEffect(() => {
        async function fetchAndSetTasks() {
            ...
            if (allTasks) {
                const newTasks = allTasks.filter(t => t.status === "Completed")
                setTasks(newTasks)
                setLoading(false)
            }
        }
                ...
                <div className="flex flex-col w-full">
                    <div className="grow bg-[rgb(248,250,252)] p-5 rounded-4xl">
                        <div className="flex flex-row justify-start items-center gap-2">
                            ...
                            <p className="" style={{ fontSize: "1.8rem" }}>&nbsp; Done &nbsp;<span className="font-bold" style={{ color: "grey" }}>({tasks.length})</span></p>
                        </div>
