            ...
            <div className="flex flex-col">
                <div className="grow bg-[rgb(248,250,252)] p-5 rounded-4xl">
                    <div className="flex flex-col">
                        ...
                        <div className="flex flex-col mt-4 max-h-96 overflow-y-auto overflow-x-hidden"> {/*Scrollable div*/}
                            {
                                noConflicts.map((item, idx) => {
                                    return (
                                        <motion.div
                                            key={idx}
                                            className="flex flex-col text-black my-2 mx-2 bg-white rounded-4xl w-80 py-2 px-5 shadow-[4px_6px_20px_1px_rgba(0,0,0,0.25)] bg-white/90 backdrop-blur-md"
                                        >
