...
const LandingPage = () => {
  ...
  // Effect for setting the navigation bar state based on authentication
  ...
  // This also runs only once to set up the event listener.
  useEffect(() => {
    const handleScroll = () => {
  ...
  return (
    <>
      ...
      <div className="landing-page-wrapper">
        <div className="landing-hero-section">
          ...
          <div className="scene-container">
            ...
            <svg viewBox="0 0 1440 600" className="road">
              <path d="M -10,300 C 360,400 360,200 720,300 S 1080,400 1450,300 L 1450,500 C 1080,600 360,400 -10,500 Z" fill="#6B7280" />
        ...
        {/* The original code had this section duplicated outside the wrapper. It is now correctly placed here and the duplicate is removed. */}
        <div className="map-section-container">
          {/* Note: The original code had a custom MapSidePanel and a hardcoded one.
              I'm keeping the custom component <MapSidePanel /> as it is more reusable. */}
          <MapSidePanel />
